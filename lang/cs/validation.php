...
return [
    ...
    'custom' => [
        'image' => [
            'uploaded' => 'Nahrávání fotografie se nezdařilo. Zkuste prosím menší soubor (max. 2 MB) nebo jiný formát.',
            'image' => 'Soubor musí být platný obrázek (JPEG, PNG, GIF, BMP).',
            'max' => 'Fotografie je příliš velká. Maximální povolená velikost je 2 MB.',
        ],

        'status' => [
            'required' => 'Musíte zvolit, zda se jedná o ztrátu, nebo nález.',
        ],
        'species' => [
            'required' => 'Prosím, zvolte druh zvířete.',
        ],
        'sex' => [
            'required' => 'Prosím, zvolte pohlaví zvířete (nebo Neznámé).',
        ],
        'report_date' => [
            'required' => 'Prosím, vyplňte datum, kdy k události došlo.',
            'date' => 'Datum není ve správném formátu.',
        ],

        'guest_email' => [
            'required_if' => 'Jelikož nejste přihlášen/a, je kontaktní e-mail povinný.',
            'email' => 'Zadaný e-mail není ve správném formátu.',
            'max' => 'E-mail je příliš dlouhý.',
        ],
        'guest_phone' => [
            'required_if' => 'Jelikož nejste přihlášen/a, je kontaktní telefon povinný.',
            'regex' => 'Zadané telefonní číslo není ve správném formátu.',
        ],
    ],
    'attributes' => [
        'name' => 'Jméno zvířete',
        'breed' => 'Rasa',
        'location_city' => 'Město události',
        'location_region' => 'Kraj události',
        'description' => 'Podrobný popis',
        'status' => 'Typ události',
        'species' => 'Druh zvířete',
        'sex' => 'Pohlaví',
        'report_date' => 'Datum události',
        'image' => 'Fotografie',
    ],
];
