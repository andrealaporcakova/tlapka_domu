<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                           class="ms-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400
                           dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                            Registrovat
                        </a>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('animal.index')" :active="request()->routeIs('animal.index')">
                Databáze zvířat
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            @auth
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('my-animals.index')">
                        Moje inzeráty
                    </x-responsive-nav-link>
